 ...
 *
 */
package com.iiifi.framework.server.manager.modules.gen.web;
...
import com.iiifi.framework.server.manager.modules.gen.service.GenSchemeService;
import com.iiifi.framework.server.manager.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.iiifi.framework.server.manager.modules");
		}
